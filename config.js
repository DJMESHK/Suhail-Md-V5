...
global.github=process.env.GITHUB|| "https://github.com/DJMESHK/Suhail-Md-V5";
...
global.userImages= process.env.USER_IMAGES || "https://github.com/DJMESHK/Suhail-Md-V5/blob/main/lib/assets/suhail.jpg?raw=true"  // "text" // set Image/video urls here
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 *𝘗𝘰𝘸𝘦𝘳𝘦𝘥 𝘣𝘺 𝘔𝘦𝘴𝘩-𝘛𝘦𝘤𝘩*』```", //*『』*\n youtube.com/@Meshkip"),
